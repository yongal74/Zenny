...
export function CustomizeModal({ visible, onClose }: CustomizeModalProps) {
    ...
    const { data: items = [] } = useQuery({
        ...
        queryFn: async () => {
            const { data } = await axios.get(`${API_BASE}/shop/items`, {
    ...
    const handleEquip = useCallback(async (itemId: string) => {
        try {
            await axios.post(`${API_BASE}/character/equip`, { itemId, slot });
        ...
        <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
            <View style={styles.container}>
                ...
                <View style={styles.coinsRow}>
                    ...
                    <Text style={styles.coinsValue}>100</Text>
                </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <TouchableOpacity
                                style={[styles.itemCard, isEquipped && styles.itemCardEquipped, !isOwned && styles.itemCardLocked]}
...
const styles = StyleSheet.create({
    ...
    equippedBadge: { backgroundColor: 'rgba(236,72,153,0.2)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
