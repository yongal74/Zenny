...
export function MeditationPlayerScreen({ track, onClose, lang = 'en' }: MeditationPlayerProps) {
    ...
    return (
        <SafeAreaView style={s.safe} edges={['top', 'bottom']}>
            <LinearGradient colors={[COLORS.bg2, COLORS.bg]} style={s.container}>
                {/* 헤더 */}
                <View style={s.header}>
...
const s = StyleSheet.create({
    ...
    outerGlow: { position: 'absolute', width: CIRCLE + 60, height: CIRCLE + 60, borderRadius: (CIRCLE + 60) / 2, backgroundColor: 'rgba(99,102,241,0.08)' },
    breathCircle: { width: CIRCLE, height: CIRCLE, borderRadius: CIRCLE / 2, backgroundColor: COLORS.surface, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'rgba(99,102,241,0.25)' },
