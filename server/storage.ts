...
export const storage = {
  ...
  async seedShopAndWellness() {
    ...
    await db.insert(shopItems).values([
      { name: "Beanie", description: "cozy knit beanie", category: "hat", price: 25, imageEmoji: "🧶", rarity: "common" },
      { name: "Top Hat", description: "classic gentleman", category: "hat", price: 75, imageEmoji: "🎩", rarity: "rare" },
      { name: "Crown", description: "royal crown", category: "hat", price: 400, imageEmoji: "👑", rarity: "legendary" },
      { name: "Baseball Cap", description: "sporty cap", category: "hat", price: 20, imageEmoji: "🧢", rarity: "common" },
      { name: "Wizard Hat", description: "magical hat", category: "hat", price: 150, imageEmoji: "🪄", rarity: "epic" },
      { name: "Party Hat", description: "celebration time", category: "hat", price: 30, imageEmoji: "🎉", rarity: "common" },
      { name: "Cowboy Hat", description: "yeehaw", category: "hat", price: 65, imageEmoji: "🤠", rarity: "rare" },
      { name: "Santa Hat", description: "holiday spirit", category: "hat", price: 80, imageEmoji: "🎅", rarity: "rare" },
      { name: "Chef Hat", description: "bon appetit", category: "hat", price: 35, imageEmoji: "👨‍🍳", rarity: "common" },
      { name: "Beret", description: "artsy vibes", category: "hat", price: 70, imageEmoji: "🎨", rarity: "rare" },

      { name: "Round Glasses", description: "classic round", category: "glasses", price: 20, imageEmoji: "👓", rarity: "common" },
      { name: "Reading Glasses", description: "scholarly look", category: "glasses", price: 25, imageEmoji: "📖", rarity: "common" },
      { name: "Monocle", description: "distinguished", category: "glasses", price: 75, imageEmoji: "🧐", rarity: "rare" },
      { name: "Nerd Glasses", description: "brainy style", category: "glasses", price: 30, imageEmoji: "🤓", rarity: "common" },
      ...
      { name: "Diamond Glasses", description: "luxury frames", category: "glasses", price: 350, imageEmoji: "💎", rarity: "legendary" },
      { name: "Retro Glasses", description: "vintage vibes", category: "glasses", price: 55, imageEmoji: "📺", rarity: "rare" },
      { name: "Star Glasses", description: "star-shaped", category: "glasses", price: 35, imageEmoji: "⭐", rarity: "common" },
      { name: "Heart Glasses", description: "lovely look", category: "glasses", price: 60, imageEmoji: "💕", rarity: "rare" },

      { name: "Aviator Shades", description: "classic cool", category: "sunglasses", price: 30, imageEmoji: "🕶️", rarity: "common" },
      ...
      { name: "Rainbow Shades", description: "colorful vibes", category: "sunglasses", price: 80, imageEmoji: "🌈", rarity: "rare" },
      { name: "Pixel Shades", description: "8-bit style", category: "sunglasses", price: 65, imageEmoji: "🎮", rarity: "rare" },
      { name: "Star Shades", description: "Hollywood", category: "sunglasses", price: 40, imageEmoji: "🌟", rarity: "common" },
      { name: "Galaxy Shades", description: "cosmic view", category: "sunglasses", price: 160, imageEmoji: "🌌", rarity: "epic" },
      ...
      { name: "Hoodie", description: "cozy hoodie", category: "clothes", price: 30, imageEmoji: "🧥", rarity: "common" },
      { name: "Tuxedo", description: "formal elegance", category: "clothes", price: 150, imageEmoji: "🤵", rarity: "epic" },
      { name: "Superhero Cape", description: "powers activate", category: "clothes", price: 85, imageEmoji: "🦸", rarity: "rare" },
      { name: "Lab Coat", description: "scientist mode", category: "clothes", price: 70, imageEmoji: "🧪", rarity: "rare" },
      { name: "Kimono", description: "traditional beauty", category: "clothes", price: 130, imageEmoji: "👘", rarity: "epic" },
      { name: "Sweater", description: "warm and fuzzy", category: "clothes", price: 25, imageEmoji: "🧶", rarity: "common" },
      { name: "Leather Jacket", description: "rebel style", category: "clothes", price: 90, imageEmoji: "🎸", rarity: "rare" },
      { name: "Royal Robe", description: "regal attire", category: "clothes", price: 450, imageEmoji: "👑", rarity: "legendary" },
      { name: "Space Suit", description: "astronaut ready", category: "clothes", price: 180, imageEmoji: "🚀", rarity: "epic" },

      { name: "Backpack", description: "adventure ready", category: "bag", price: 20, imageEmoji: "🎒", rarity: "common" },
      ...
      { name: "Treasure Chest", description: "pirate loot", category: "bag", price: 140, imageEmoji: "🏴‍☠️", rarity: "epic" },
      { name: "Gift Bag", description: "surprise inside", category: "bag", price: 60, imageEmoji: "🎁", rarity: "rare" },
      { name: "Magic Pouch", description: "enchanted bag", category: "bag", price: 75, imageEmoji: "🔮", rarity: "rare" },
      ...
      { name: "Star Badge", description: "shining star", category: "badge", price: 20, imageEmoji: "⭐", rarity: "common" },
      { name: "Heart Badge", description: "love emblem", category: "badge", price: 25, imageEmoji: "💖", rarity: "common" },
      { name: "Shield Badge", description: "protector", category: "badge", price: 60, imageEmoji: "🛡️", rarity: "rare" },
      { name: "Fire Badge", description: "blazing spirit", category: "badge", price: 70, imageEmoji: "🔥", rarity: "rare" },
      { name: "Lightning Badge", description: "electric power", category: "badge", price: 65, imageEmoji: "⚡", rarity: "rare" },
      ...
      { name: "Fairy Wings", description: "delicate fairy", category: "wings", price: 35, imageEmoji: "🧚", rarity: "common" },
      { name: "Angel Wings", description: "heavenly glow", category: "wings", price: 85, imageEmoji: "👼", rarity: "rare" },
      { name: "Butterfly Wings", description: "colorful flutter", category: "wings", price: 75, imageEmoji: "🦋", rarity: "rare" },
      { name: "Dragon Wings", description: "fierce power", category: "wings", price: 170, imageEmoji: "🐉", rarity: "epic" },
      { name: "Phoenix Wings", description: "reborn in fire", category: "wings", price: 400, imageEmoji: "🔥", rarity: "legendary" },
      ...
      { name: "Rainbow Wings", description: "prismatic beauty", category: "wings", price: 90, imageEmoji: "🌈", rarity: "rare" },
      ...
      { name: "Kitten", description: "tiny meow", category: "pet", price: 30, imageEmoji: "🐱", rarity: "common" },
      { name: "Puppy", description: "loyal friend", category: "pet", price: 30, imageEmoji: "🐶", rarity: "common" },
      { name: "Bunny", description: "fluffy hop", category: "pet", price: 35, imageEmoji: "🐰", rarity: "common" },
      { name: "Hamster", description: "tiny wheel", category: "pet", price: 25, imageEmoji: "🐹", rarity: "common" },
      { name: "Fox", description: "clever friend", category: "pet", price: 70, imageEmoji: "🦊", rarity: "rare" },
      { name: "Owl", description: "wise companion", category: "pet", price: 80, imageEmoji: "🦉", rarity: "rare" },
      { name: "Dragon Baby", description: "fire breather", category: "pet", price: 180, imageEmoji: "🐲", rarity: "epic" },
      { name: "Unicorn", description: "magical friend", category: "pet", price: 160, imageEmoji: "🦄", rarity: "epic" },
      { name: "Phoenix Chick", description: "baby phoenix", category: "pet", price: 400, imageEmoji: "🐦‍🔥", rarity: "legendary" },
